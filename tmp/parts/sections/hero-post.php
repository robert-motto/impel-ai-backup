			...
			<div class="hero-post__content">
				...
				<div class="hero-post__desc">
					<div class="hero-post__desc__item">
						<span class="hero-post__desc__item__label"><?php _e('Written By', get_option('template')); ?></span>
						<span class="hero-post__desc__item__value "><?php echo $written_by; ?></span>
					</div>
					<?php if(!empty($edited_by)) : ?>
						<div class="hero-post__desc__item">
							<span class="hero-post__desc__item__label"><?php _e('Edited By', get_option('template')); ?></span>
							<span class="hero-post__desc__item__value "><?php echo $edited_by; ?></span>
						</div>
					<?php endif;?>
					<?php if(!empty($reviewed_by)) : ?>
						<div class="hero-post__desc__item">
							<span class="hero-post__desc__item__label"><?php _e('Reviewed By', get_option('template')); ?></span>
							<span class="hero-post__desc__item__value "><?php echo $reviewed_by; ?></span>
						</div>
					<?php endif;?>
					<div class="hero-post__desc__item">
						<span class="hero-post__desc__item__label"><?php _e('Published', get_option('template')); ?></span>
						<span class="hero-post__desc__item__value "><?php echo $publish_date; ?></span>
					</div>
				</div>
			</div>
			<?php

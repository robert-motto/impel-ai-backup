...
<?php else :?>
	...
	?>
	<section <?php echo section_settings_id($group); ?> class="<?php echo esc_attr(implode(' ', $classes)); ?> <?php echo section_settings_padding_classes($group); ?>" data-block="grid-of-items" data-style="<?php echo esc_attr($item_style); ?>">

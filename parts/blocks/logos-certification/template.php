...
<?php else :?>
	<?php
		...
		$display_mode     = $group['display_mode'] ?? 'row';
		$logos            = $group['logos'] ?? [];
		...
		$classes = ['l-section', 'l-section--logos-certification', 'js-logos-certification'];
		if ($has_background) {
			$classes[] = 'is-' . $background_color;
		}

		$classes[] = 'is-' . $layout_variant;
	...
	<section <?php echo section_settings_id($group); ?> class="<?php echo esc_attr(implode(' ', $classes)); ?> <?php echo section_settings_padding_classes($group); ?>" data-block="logos-certification">
		<div class="logos-certification l-wrapper">
			<div class="logos-certification__content">
				<?php if (!empty($caption)) : ?>
					<div class="logos-certification__caption">
						<?php echo esc_html($caption); ?>
					</div>
				<?php endif; ?>
				<?php if (!empty($heading)) : ?>
					<div class="logos-certification__heading">
						<?php echo $heading; ?>
					</div>
				<?php endif; ?>
				<?php if (!empty($content)) : ?>
					<div class="logos-certification__body">
						<?php echo $content; ?>
					</div>
				<?php endif; ?>
				<?php
				...
				<div class="logos-certification__carousel-container">
					<div class="logos-certification__carousel js-logos-carousel swiper" id="<?php echo esc_attr($unique_id); ?>"
						...
						<?php if ($display_mode === 'carousel') : ?>
							<div class="logos-certification__navigation">
								<div class="logos-certification__button-prev js-logos-prev"></div>
								<div class="logos-certification__button-next js-logos-next"></div>
							</div>
						<?php endif; ?>
					</div>
				</div>

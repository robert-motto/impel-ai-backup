...
?>
	<div class="post-listing__filters-hld">
		...
		<span class="post-listing__filters-label t-caption t-caption--1"> <?php echo $categories_label; ?></span>
		...
		<div class="post-listing__filters">
			<div>
				<div>
					<a class="post-listing__filters__item js-filter-item t-caption t-caption--2 <?php echo empty($current_cat_slug) ? 'is-active' : ''; ?>" href="<?php echo $all_posts_link; ?>" title="<?php _e('See all posts', 'motto-theme'); ?>">
						<?php echo $all_filters_label; ?>
					</a>
					<?php foreach($categories as $category) : ?>
						<a class="post-listing__filters__item js-filter-item t-caption t-caption--2 <?php echo $current_cat_slug === $category->slug ? 'is-active' : '';?>" href="<?php echo get_term_link($category->term_id).''.$params; ?>" title="<?php echo __('See posts form category - ', 'motto-theme').$category->name;?>">

...
?>
	<div class="post-listing__filters-hld">
		...
		<span class="post-listing__filters-label t-caption t-caption--1"> <?php echo $tags_label; ?></span>
		...
		<div class="post-listing__filters">
			<div>
				<div>
					<a class="post-listing__filters__item js-filter-item t-caption t-caption--2 <?php echo empty($current_tag_slug) ? 'is-active' : ''; ?>" href="<?php echo $base_url; ?>" title="<?php _e('See posts with all tags', 'motto-theme'); ?>">
						<?php echo $all_filters_label; ?>
					</a>
					<?php foreach($tags as $tag) : ?>
						<a class="post-listing__filters__item js-filter-item t-caption t-caption--2 <?php echo $current_tag_slug === $tag->slug ? 'is-active' : '';?>" href="<?php echo $base_url.''.'?topic='.$tag->slug.''.$params; ?>" title="<?php echo __('See posts with tag - ', 'motto-theme').$tag->name;?>">
							<?php echo $tag->name; ?>
						</a>
					<?php endforeach; ?>
				</div>

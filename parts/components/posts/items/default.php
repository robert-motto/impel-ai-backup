...
<article class="post-item <?php echo $classes; ?>">
	<a href="<?php echo $link_url; ?>" class="post-item__link" title="<?php echo $link_title; ?>">
		...
		<div class="post-item__content">
			...
			<span class="post-item__title t-heading t-heading--h5"><?php echo $title; ?></span>
			<?php if($has_description) : ?>
				<p class="post-item__description t-paragraph t-paragraph--3"><?php echo get_the_excerpt($post_id); ?></p>
			<?php endif; ?>

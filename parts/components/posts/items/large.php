...
?>
<article class="post-item post-item--large is-dark <?php echo $classes; ?>">
	<a href="<?php echo $link_url; ?>" class="post-item__link" title="<?php echo $link_title; ?>">
		...
		<div class="post-item__content">
			<?php if(!empty($primary_category)) : ?>
				<span class="post-item__category category-tag t-caption t-caption--2 is-light"><?php echo $primary_category['primary_category']->name; ?></span>
			<?php endif; ?>
			<span class="post-item__title t-heading t-heading--h4"><?php echo $title; ?></span>
